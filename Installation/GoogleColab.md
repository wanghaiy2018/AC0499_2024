You can run Python program within Google Colab. **NO INSTALLATION** is needed. Here for example, to call LLM server in Colab Installation/openai.ipynb, you can simply click the icon "Open in Colab"
